		...
		data = {
			youth = {
				...
				variants = {
					...
					{ name = "MAGE_CLOTH_HUMANMAGE", description = "Mage Cloth", colors = "B18134,9B6C31,87592F,7B4C2F,6A412F,533730,402D22,2D2410"},
					{ name = "MAGE_CLOTH_REDMAGE", description = "Red Mage Cloth", colors = "C5956A,B9895E,AD7D53,9F724C,916949,7F5B43,664839,4E3430"},
					{ name = "MAGE_CLOTH_ARCHMAGE", description = "Arch Mage Cloth", colors = "CABCA2,B4A78D,A0937A,8D8169,7A6F57,685C45,594E38,4B402B"},
					{ name = "MAGE_CLOTH_SILVER_MAGE", description = "Silver Mage Cloth", colors = "C0D7E0,A5C2CE,8DB0BC,83A6A9,78949A,6C7E8D,546079,384062"},
					{ name = "MAGE_CLOTH_WHITE_MAGE", description = "White Mage Cloth", colors = "C0D7E0,ABC7D2,97B8C4,82A3B2,6E8B9E,5C7589,4F6475,425361"},
					{ name = "MAGE_CLOTH_MAGE_HOOD", description = "Mage Hood Cloth", colors = "BFBFBF,9B9B9B,818384,878E96,7C838B,606163,545454,4D4D4D"},
					{ name = "MAGE_CLOTH_SILVER_MAGE_HOOD", description = "Silver Mage Hood Cloth", colors = "D6D6D6,C4C4C4,B1B1B1,9D9D9D,888888,747474,606060,4D4D4D"},
					{ name = "MAGE_CLOTH_WHITE_MAGE_HOOD", description = "White Mage Hood Cloth", colors = "D3CBBB,A9ACAB,88909A,7F8285,686B6E,454C55,2D3942,182830"},
					{ name = "MAGE_CLOTH_ELDER_MAGE", description = "Elder Mage Cloth", colors = "84401E,7D3917,733112,622B15,532614,452211,391B11,2C1212"},
					{ name = "MAGE_CLOTH_ELDER_MAGE_HOOD", description = "Elder Mage Hood Cloth", colors = "A4977E,92856D,7F745C,6D614A,5C513B,4E432E,3E341F,2D2410"},
					{ name = "MAGE_CLOTH_DELFADOR_HTTT", description = "Delfador Cloth (HttT)", colors = "834D70,763C69,672B62,521759,430A4E,3A0441,2F0237,22012D"},
					{ name = "MAGE_CLOTH_DELFADOR_HTTT_HOOD", description = "Delfador Hood Cloth (HttT)", colors = "3D8381,21726B,0B6059,084E4F,063C43,042E35,03202B,031222"},
					{ name = "MAGE_CLOTH_DELFADOR_TDG3", description = "Delfador Cloth (TDG)", colors = "D4AE76,BA9462,9F7A4F,806240,60533C,404D45,2E3937,212121"},
					{ name = "MAGE_CLOTH_DELFADOR_TDG4", description = "Delfador Cloth Grey (TDG)", colors = "D2D2D2,BCBCBC,A4A4A4,888888,6D6D6D,535353,444C4A,384B47"},
					{ name = "MAGE_CLOTH_DARKER", description = "Darker Cloth", colors = "818442,717139,615D2F,545330,494D36,3C4535,2F3A28,212E1A"},
					{ name = "MAGE_CLOTH_GREENPURPLE", description = "Green Purple", colors = "93A167,838965,737163,625A5E,4F4359,3A2D49,1D1625,000001"},
					{ name = "MAGE_CLOTH_GREENRED", description = "Green Red", colors = "A19F7C,8F8D69,7D7A55,706449,674C40,573B37,3C3B2E,213B25"},
					{ name = "MAGE_CLOTH_BROWNREDPURPLE", description = "Brown Red Purple", colors = "826E2F,7C5E28,774E20,683D27,542D33,461F37,421A28,3F1519"},
					{ name = "MAGE_CLOTH_BROWNGREY", description = "Brown Grey", colors = "84754A,72643E,5F5333,544B34,4C463A,434039,373628,2B2C16"},
					{ name = "MAGE_CLOTH_DARKBROWN", description = "Dark Brown", colors = "A08662,8F795C,7E6B57,695A4B,52463E,3D3530,302825,221C1A"},
					{ name = "MAGE_CLOTH_LIGHTBROWN", description = "Light Brown", colors = "CDA184,B4866B,9B6A52,86553C,6F4026,5F3116,4B2410,38160A"},
					{ name = "MAGE_CLOTH_BROWNGREYGREEN", description = "Brown Greygreen", colors = "8F6C61,805D4F,704E3C,614B3A,514E40,474B40,473B33,472B27"},
					{ name = "MAGE_CLOTH_ORANGEBLUE", description = "Orange Blue", colors = "D08159,B37767,966C75,6D5C70,404960,1D3A54,15324C,0D2B45"},
					{ name = "MAGE_CLOTH_BLUE", description = "Blue", colors = "50596E,3E4A5B,2D3A47,273643,273946,263745,212D3E,1D2336"},
					{ name = "MAGE_CLOTH_PURPLE", description = "Purple", colors = "9D7D95,866981,6F556D,614B63,57475E,4C4056,3F354B,322A3F"},
					{ name = "MAGE_CLOTH_GREY", description = "Grey", colors = "909090,828282,747474,626262,505050,3E3E3E,303030,212121"},
					{ name = "MAGE_CLOTH_GREYBROWN", description = "Grey Brown", colors = "576D6D,6D7466,837B5F,7C6B51,67513F,513A31,3A2C2A,221E23"},
					{ name = "MAGE_CLOTH_GREYRED", description = "Grey Red", colors = "AAAA8E,929282,797975,696161,5D4949,513939,452F2F,393939"},
					{ name = "MAGE_CLOTH_ORC_SHAMAN", description = "Orc Shaman", colors = "9AAB60,8B934C,7A7A38,615B25,4C4418,393212,2B260E,312B0A"},
					{ name = "MAGE_CLOTH_DUNEBURNER", description = "Dune Burner", colors = "D5D3A1,BEBD95,A7A688,96927B,897E6E,776960,5E5052,453843"},
					{ name = "MAGE_CLOTH_DUNEHERBALIST", description = "Dune Herbalist", colors = "B8A641,9D9B50,82915E,6E7F53,5E6C3C,4E5829,3F451E,303313"},
					{ name = "MAGE_CLOTH_DARKDUNE", description = "Dark Dune Cloth", colors = "E6E6CC,CCCCB1,B2B297,999986,828279,696969,515151,393939"},
					{ name = "MAGE_CLOTH_LIGHTDUNE", description = "Light Dune Cloth", colors = "F6F6DA,E8E7C2,DAD8A9,CDCB9B,C2C191,AAA881,7B7561,4B4142"},
					{ name = "MAGE_CLOTH_ROGUE_MAGE", description = "Rogue Mage Cloth", colors = "636363,535353,46463D,404012,383708,2D2B19,222519,152114"},
					{ name = "MAGE_CLOTH_DARKADEPT", description = "Dark Adept Cloth", colors = "A5B89C,99AA90,8C9C84,788A74,607664,4A6051,39483D,283028"},
					{ name = "MAGE_CLOTH_ELVISHSHAMAN", description = "Elvish Shaman Cloth", colors = "EFFF9C,CBF180,A8E363,87C950,67A943,528F37,508130,4F7229"},
					{ name = "MAGE_CLOTH_SAURIANAUGUR", description = "Saurian Augur Cloth", colors = "FFFFFF,D4D4D0,A9AAA1,85877D,66675E,494B45,303638,17212C"},
					{ name = "MAGE_CLOTH_SAURIANORACLE", description = "Saurian Oracle Cloth", colors = "FFFFFF,CEE5E5,9DCBCE,71A0A9,486E85,294663,203347,17212C"},
					{ name = "MAGE_CLOTH_SAURIANPROPHET", description = "Saurian Prophet Cloth", colors = "FFD44A,FFDB6E,FFE391,ECC26F,D2902E,B16100,843D01,581802"},
					{ name = "MAGE_CLOTH_SAURIANSEER", description = "Saurian Seer Cloth", colors = "FFFFFF,FFEDB1,FFDA63,ECB635,D28B15,B16100,843D01,581802"}
				},
			},
			fighter = {
				unit_types = {	"Quenoth Fighter","Quenoth Fighter1","Quenoth Fighter2","Quenoth Fighter3","Quenoth Fighter4","Quenoth Fighter5","Quenoth Fighter6","Quenoth Fighter7","Quenoth Fighter8","Quenoth Fighter9","Quenoth Fighter10","Quenoth Warrior","Quenoth Champion",
		...
		data = {
			...
			druid = {
				...
				variants = {
					...
					{ name = "MAGE_CLOTH_HUMANMAGE", description = "Mage Cloth", colors = "B18134,B18134,976831,83552F,75462F,5B3A30,432F25,432F25,2D2410,2D2410,2D2410" },
					{ name = "MAGE_CLOTH_REDMAGE", description = "Red Mage Cloth", colors = "C5956A,C5956A,B7875D,A9794F,986E4B,876246,6B4B3B,6B4B3B,4E3430,4E3430,4E3430" },
					{ name = "MAGE_CLOTH_ARCHMAGE", description = "Arch Mage Cloth", colors = "CABCA2,CABCA2,B1A38A,998D74,847860,6E634B,5B503A,5B503A,4B402B,4B402B,4B402B" },
					{ name = "MAGE_CLOTH_SILVER_MAGE", description = "Silver Mage Cloth", colors = "C0D7E0,C0D7E0,A0BFCB,8AADB5,7EA0A0,708591,59657D,59657D,384062,384062,384062" },
					{ name = "MAGE_CLOTH_WHITE_MAGE", description = "White Mage Cloth", colors = "C0D7E0,C0D7E0,A8C5D0,90B3C0,7897A8,607B90,516779,516779,425361,425361,425361" },
					{ name = "MAGE_CLOTH_MAGE_HOOD", description = "Mage Hood Cloth", colors = "BFBFBF,BFBFBF,959595,83878A,8A949F,696C70,555555,555555,4D4D4D,4D4D4D,4D4D4D" },
					{ name = "MAGE_CLOTH_SILVER_MAGE_HOOD", description = "Silver Mage Hood Cloth", colors = "D6D6D6,D6D6D6,C1C1C1,ABABAB,929292,7A7A7A,646464,646464,4D4D4D,4D4D4D,4D4D4D" },
					{ name = "MAGE_CLOTH_WHITE_MAGE_HOOD", description = "White Mage Hood Cloth", colors = "D3CBBB,D3CBBB,A2A6A8,858B93,7A7A7A,51575D,303B45,303B45,182830,182830,182830" },
					{ name = "MAGE_CLOTH_ELDER_MAGE", description = "Elder Mage Cloth", colors = "84401E,84401E,7B3715,6D2F13,5A2816,4A2312,3B1C11,3B1C11,2C1212,2C1212,2C1212" },
					{ name = "MAGE_CLOTH_ELDER_MAGE_HOOD", description = "Elder Mage Hood Cloth", colors = "A4977E,A4977E,8F826A,796D56,635841,534832,413722,413722,2D2410,2D2410,2D2410" },
					{ name = "MAGE_CLOTH_DELFADOR_HTTT", description = "Delfador Cloth (HttT)", colors = "834D70,834D70,743A68,60245F,470D55,3D0646,310238,310238,22012D,22012D,22012D" },
					{ name = "MAGE_CLOTH_DELFADOR_HTTT_HOOD", description = "Delfador Hood Cloth (HttT)", colors = "3D8381,3D8381,1C6F68,0A5A55,07444A,04333A,03222D,03222D,031222,031222,031222" },
					{ name = "MAGE_CLOTH_DELFADOR_TDG3", description = "Delfador Cloth (TDG)", colors = "D4AE76,D4AE76,B68F5F,95724A,705638,4B4F42,303D3A,303D3A,212121,212121,212121" },
					{ name = "MAGE_CLOTH_DELFADOR_TDG4", description = "Delfador Cloth Grey (TDG)", colors = "D2D2D2,D2D2D2,B8B8B8,9B9B9B,7A7A7A,5C5C5C,464C4B,464C4B,384B47,384B47,384B47" },
					{ name = "MAGE_CLOTH_DARKER", description = "Darker Cloth", colors = "818442,818442,6E6E37,5C572C,4E5033,41493A,313C2A,313C2A,212E1A,212E1A,212E1A" },
					{ name = "MAGE_CLOTH_GREENPURPLE", description = "Green Purple", colors = "93A167,93A167,808564,6E6962,584E5B,433455,211A2B,211A2B,000001,000001,000001" },
					{ name = "MAGE_CLOTH_GREENRED", description = "Green Red", colors = "A19F7C,A19F7C,8C8A66,77744F,6C5844,603B3A,403B30,403B30,213B25,213B25,213B25" },
					{ name = "MAGE_CLOTH_BROWNREDPURPLE", description = "Brown Red Purple", colors = "826E2F,826E2F,7C5C26,75491E,5E352D,47213C,431B2B,431B2B,3F1519,3F1519,3F1519" },
					{ name = "MAGE_CLOTH_BROWNGREY", description = "Brown Grey", colors = "84754A,84754A,6F623C,594E2F,504837,47433F,39382B,39382B,2B2C16,2B2C16,2B2C16" },
					{ name = "MAGE_CLOTH_DARKBROWN", description = "Dark Brown", colors = "A08662,A08662,8D765C,796755,5E5044,423934,322A27,322A27,221C1A,221C1A,221C1A" },
					{ name = "MAGE_CLOTH_LIGHTBROWN", description = "Light Brown", colors = "CDA184,CDA184,B08167,93614A,7C4C31,653618,4E2611,4E2611,38160A,38160A,38160A" },
					{ name = "MAGE_CLOTH_BROWNGREYGREEN", description = "Brown Greygreen", colors = "8F6C61,8F6C61,7D5B4C,6B4936,594D3D,475044,473E36,473E36,472B27,472B27,472B27" },
					{ name = "MAGE_CLOTH_ORANGEBLUE", description = "Orange Blue", colors = "D08159,D08159,AF756A,8D697A,575368,203C56,17344E,17344E,0D2B45,0D2B45,0D2B45" },
					{ name = "MAGE_CLOTH_BLUE", description = "Blue", colors = "50596E,50596E,3C4758,273541,273844,273A48,222F3F,222F3F,1D2336,1D2336,1D2336" },
					{ name = "MAGE_CLOTH_PURPLE", description = "Purple", colors = "9D7D95,9D7D95,83667E,684E67,5C4961,50445A,41374D,41374D,322A3F,322A3F,322A3F" },
					{ name = "MAGE_CLOTH_GREY", description = "Grey", colors = "909090,909090,808080,6F6F6F,595959,434343,323232,323232,212121,212121,212121" },
					{ name = "MAGE_CLOTH_GREYBROWN", description = "Grey Brown", colors = "576D6D,576D6D,717565,8A7D5D,725E48,593F33,3E2F2B,3E2F2B,221E23,221E23,221E23" },
					{ name = "MAGE_CLOTH_GREYRED", description = "Grey Red", colors = "AAAA8E,AAAA8E,8E8E80,717171,635555,553939,472F2F,472F2F,393939,393939,393939" },
					{ name = "MAGE_CLOTH_ORC_SHAMAN", description = "Orc Shaman", colors = "9AAB60,9AAB60,898F49,726F32,554C1B,3F3814,473F14,473F14,312B0A,312B0A,312B0A" },
					{ name = "MAGE_CLOTH_DUNEBURNER", description = "Dune Burner", colors = "D5D3A1,D5D3A1,BBB993,A09F84,908875,7F7165,625554,625554,453843,453843,453843" },
					{ name = "MAGE_CLOTH_DUNEHERBALIST", description = "Dune Herbalist", colors = "B8A641,B8A641,999A52,798D63,667648,535E2D,424920,424920,303313,303313,303313" },
					{ name = "MAGE_CLOTH_DARKDUNE", description = "Dark Dune Cloth", colors = "E6E6CC,E6E6CC,C8C8AD,AAAA8E,8E8E80,717171,555555,555555,393939,393939,393939" },
					{ name = "MAGE_CLOTH_LIGHTDUNE", description = "Light Dune Cloth", colors = "F6F6DA,F6F6DA,E6E5BE,D5D3A1,C8C696,BAB98B,837D67,837D67,4B4142,4B4142,4B4142" },
					{ name = "MAGE_CLOTH_ROGUE_MAGE", description = "Rogue Mage Cloth", colors = "636363,636363,505050,44442F,3D3D00,211F13,24261A,24261A,152114,152114,152114" },
					{ name = "MAGE_CLOTH_DARKADEPT", description = "Dark Adept Cloth", colors = "A5B89C,A5B89C,97A88E,889880,6C806C,506858,3C4C40,3C4C40,283028,283028,283028" },
					{ name = "MAGE_CLOTH_ELVISHSHAMAN", description = "Elvish Shaman Cloth", colors = "EFFF9C,EFFF9C,C6EF7B,9CDE5A,77B94A,529439,518331,518331,4F7229,4F7229,4F7229" },
					{ name = "MAGE_CLOTH_SAURIANAUGUR", description = "Saurian Augur Cloth", colors = "FFFFFF,FFFFFF,CDCECE,9B9C92,76776E,515249,343A3B,343A3B,17212C,17212C,17212C" },
					{ name = "MAGE_CLOTH_SAURIANORACLE", description = "Saurian Oracle Cloth", colors = "FFFFFF,FFFFFF,C6E1E1,8DC2C2,5D8797,2C4C6C,22374C,22374C,17212C,17212C,17212C" },
					{ name = "MAGE_CLOTH_SAURIANPROPHET", description = "Saurian Prophet Cloth", colors = "FFD44A,FFD44A,FFDD74,FFE59D,DFA94F,BF6D00,8C4301,8C4301,581802,581802,581802" },
					{ name = "MAGE_CLOTH_SAURIANSEER", description = "Saurian Seer Cloth", colors = "FFFFFF,FFFFFF,FFEAA5,FFD44A,DFA125,BF6D00,8C4301,8C4301,581802,581802,581802" }
				},
			},
			shyde = {
				unit_types = {	"Quenoth Shyde" },
			...
			sun_sylph = {
				...
				variants = {
					...
					{ name = "MYSTIC_SHYDE", description = "Shyde Robe", colors = "C9C49E,A3AB5B,898B5F,436448,494428,313926" },
					{ name = "MYSTIC_SINGER", description = "Sun Singer Robe", colors = "D8D4AC,BDBE86,9FA563,726F20,545218,37370F" },
					{ name = "TAN_CAPE", description = "Tan Cape", colors = "EFD9CB,CBBEB9,BFAFAB,6F615E,483D3A,342A29" },
					{ name = "TAN_HEADSCARF", description = "Tan Headscarf", colors = "DBC5AF,C3A89F,9C8B8B,74605D,5C4744,372725" },
					{ name = "MAGE_CLOTH_HUMANMAGE", description = "Mage Cloth", colors = "B18134,976831,75462F,5B3A30,432F25,2D2410" },
					{ name = "MAGE_CLOTH_REDMAGE", description = "Red Mage Cloth", colors = "C5956A,B7875D,986E4B,876246,6B4B3B,4E3430" },
					{ name = "MAGE_CLOTH_ARCHMAGE", description = "Arch Mage Cloth", colors = "CABCA2,B1A38A,847860,6E634B,5B503A,4B402B" },
					{ name = "MAGE_CLOTH_SILVER_MAGE", description = "Silver Mage Cloth", colors = "C0D7E0,A0BFCB,7EA0A0,708591,59657D,384062" },
					{ name = "MAGE_CLOTH_WHITE_MAGE", description = "White Mage Cloth", colors = "C0D7E0,A8C5D0,7897A8,607B90,516779,425361" },
					{ name = "MAGE_CLOTH_MAGE_HOOD", description = "Mage Hood Cloth", colors = "BFBFBF,959595,8A949F,696C70,555555,4D4D4D" },
					{ name = "MAGE_CLOTH_SILVER_MAGE_HOOD", description = "Silver Mage Hood Cloth", colors = "D6D6D6,C1C1C1,929292,7A7A7A,646464,4D4D4D" },
					{ name = "MAGE_CLOTH_WHITE_MAGE_HOOD", description = "White Mage Hood Cloth", colors = "D3CBBB,A2A6A8,7A7A7A,51575D,303B45,182830" },
					{ name = "MAGE_CLOTH_ELDER_MAGE", description = "Elder Mage Cloth", colors = "84401E,7B3715,5A2816,4A2312,3B1C11,2C1212" },
					{ name = "MAGE_CLOTH_ELDER_MAGE_HOOD", description = "Elder Mage Hood Cloth", colors = "A4977E,8F826A,635841,534832,413722,2D2410" },
					{ name = "MAGE_CLOTH_DELFADOR_HTTT", description = "Delfador Cloth (HttT)", colors = "834D70,743A68,470D55,3D0646,310238,22012D" },
					{ name = "MAGE_CLOTH_DELFADOR_HTTT_HOOD", description = "Delfador Hood Cloth (HttT)", colors = "3D8381,1C6F68,07444A,04333A,03222D,031222" },
					{ name = "MAGE_CLOTH_DELFADOR_TDG3", description = "Delfador Cloth (TDG)", colors = "D4AE76,B68F5F,705638,4B4F42,303D3A,212121" },
					{ name = "MAGE_CLOTH_DELFADOR_TDG4", description = "Delfador Cloth Grey (TDG)", colors = "D2D2D2,B8B8B8,7A7A7A,5C5C5C,464C4B,384B47" },
					{ name = "MAGE_CLOTH_DARKER", description = "Darker Cloth", colors = "818442,6E6E37,4E5033,41493A,313C2A,212E1A" },
					{ name = "MAGE_CLOTH_GREENPURPLE", description = "Green Purple", colors = "93A167,808564,584E5B,433455,211A2B,000001" },
					{ name = "MAGE_CLOTH_GREENRED", description = "Green Red", colors = "A19F7C,8C8A66,6C5844,603B3A,403B30,213B25" },
					{ name = "MAGE_CLOTH_BROWNREDPURPLE", description = "Brown Red Purple", colors = "826E2F,7C5C26,5E352D,47213C,431B2B,3F1519" },
					{ name = "MAGE_CLOTH_BROWNGREY", description = "Brown Grey", colors = "84754A,6F623C,504837,47433F,39382B,2B2C16" },
					{ name = "MAGE_CLOTH_DARKBROWN", description = "Dark Brown", colors = "A08662,8D765C,5E5044,423934,322A27,221C1A" },
					{ name = "MAGE_CLOTH_LIGHTBROWN", description = "Light Brown", colors = "CDA184,B08167,7C4C31,653618,4E2611,38160A" },
					{ name = "MAGE_CLOTH_BROWNGREYGREEN", description = "Brown Greygreen", colors = "8F6C61,7D5B4C,594D3D,475044,473E36,472B27" },
					{ name = "MAGE_CLOTH_ORANGEBLUE", description = "Orange Blue", colors = "D08159,AF756A,575368,203C56,17344E,0D2B45" },
					{ name = "MAGE_CLOTH_BLUE", description = "Blue", colors = "50596E,3C4758,273844,273A48,222F3F,1D2336" },
					{ name = "MAGE_CLOTH_PURPLE", description = "Purple", colors = "9D7D95,83667E,5C4961,50445A,41374D,322A3F" },
					{ name = "MAGE_CLOTH_GREY", description = "Grey", colors = "909090,808080,595959,434343,323232,212121" },
					{ name = "MAGE_CLOTH_GREYBROWN", description = "Grey Brown", colors = "576D6D,717565,725E48,593F33,3E2F2B,221E23" },
					{ name = "MAGE_CLOTH_GREYRED", description = "Grey Red", colors = "AAAA8E,8E8E80,635555,553939,472F2F,393939" },
					{ name = "MAGE_CLOTH_ORC_SHAMAN", description = "Orc Shaman", colors = "9AAB60,898F49,554C1B,3F3814,473F14,312B0A" },
					{ name = "MAGE_CLOTH_DUNEBURNER", description = "Dune Burner", colors = "D5D3A1,BBB993,908875,7F7165,625554,453843" },
					{ name = "MAGE_CLOTH_DUNEHERBALIST", description = "Dune Herbalist", colors = "B8A641,999A52,667648,535E2D,424920,303313" },
					{ name = "MAGE_CLOTH_DARKDUNE", description = "Dark Dune Cloth", colors = "E6E6CC,C8C8AD,8E8E80,717171,555555,393939" },
					{ name = "MAGE_CLOTH_LIGHTDUNE", description = "Light Dune Cloth", colors = "F6F6DA,E6E5BE,C8C696,BAB98B,837D67,4B4142" },
					{ name = "MAGE_CLOTH_ROGUE_MAGE", description = "Rogue Mage Cloth", colors = "636363,505050,3D3D00,211F13,24261A,152114" },
					{ name = "MAGE_CLOTH_DARKADEPT", description = "Dark Adept Cloth", colors = "A5B89C,97A88E,6C806C,506858,3C4C40,283028" },
					{ name = "MAGE_CLOTH_ELVISHSHAMAN", description = "Elvish Shaman Cloth", colors = "EFFF9C,C6EF7B,77B94A,529439,518331,4F7229" },
					{ name = "MAGE_CLOTH_SAURIANAUGUR", description = "Saurian Augur Cloth", colors = "FFFFFF,CDCECE,76776E,515249,343A3B,17212C" },
					{ name = "MAGE_CLOTH_SAURIANORACLE", description = "Saurian Oracle Cloth", colors = "FFFFFF,C6E1E1,5D8797,2C4C6C,22374C,17212C" },
					{ name = "MAGE_CLOTH_SAURIANPROPHET", description = "Saurian Prophet Cloth", colors = "FFD44A,FFDD74,DFA94F,BF6D00,8C4301,581802" },
					{ name = "MAGE_CLOTH_SAURIANSEER", description = "Saurian Seer Cloth", colors = "FFFFFF,FFEAA5,DFA125,BF6D00,8C4301,581802" }
				},
			},
		}
	},
		...
		data = {
			youth = {
				...
				variants = {
					...
					{ name = "RED_FIGHTER", description = "Red Fighter Metal", colors = "F1DDD9,D9AEA6,BD696E,9F2133,6A343B,3F2A31" },
					{ name = "RED_ASSASSIN", description = "Red Assassin Metal", colors = "EACCC6,BCA39D,9D6B6F,7D303B,57373B,3F2A31" },
			...
			archer = {
				...
				variants = {
					...
					{ name = "BLUE_YOUTH", description = "Blue Youth Metal", colors = "E7FFCE,CDFAB4,A4F19D,78C1B2,4C91C9,4A707A,4A2E62" },
					{ name = "RED_YOUTH", description = "Red Youth Metal", colors = "DACBCB,C4ABAB,B38E8E,8A4C4C,664B50,50363B,3B2328" },
					{ name = "RED_FIGHTER", description = "Red Fighter Metal", colors = "F1DDD9,EACCC6,D9AEA6,BD696E,9F2133,6A343B,3F2A31" },
					{ name = "RED_ASSASSIN", description = "Red Assassin Metal", colors = "EACCC6,ECC3C1,BCA39D,9D6B6F,7D303B,57373B,3F2A31" },
					{ name = "CORRUPTED", description = "Corrupted Metal", colors = "F3E1DD,EACCC,BCA39D,9D6B6F,7D303B,57373B,3F2A31" },
					--blue armour
			...
			tauroch = {
				...
				variants = {
					{ name = "DEFAULT", description = "Default", colors = "FCFFDC,FFE593,A4F19D,78C1B2,8B9A88,4C91C9,BDD6E6,89BBB5,8592B9,4A707A,4A2E62" },
					{ name = "BLUE_YOUTH", description = "Blue Youth Metal", colors = "E7FFCE,F2FFEA,A4F19D,78C1B2,4C91C9,A4F19D,78C1B2,4C91C9,69818A,4A707A,4A2E62" },
					{ name = "RED_YOUTH", description = "Red Youth Metal", colors = "DACBCB,C4ABAB,B38E8E,8A4C4C,664B50,C4ABAB,B38E8E,8A4C4C,664B50,50363B,3B2328" },
					{ name = "RED_FIGHTER", description = "Red Fighter Metal", colors = "F1DDD9,EACCC6,D9AEA6,BD696E,9F2133,EACCC6,D9AEA6,BD696E,9F2133,6A343B,3F2A31" },
					{ name = "RED_ASSASSIN", description = "Red Assassin Metal", colors = "F3E1DD,EACCC6,BCA39D,9D6B6F,7D303B,EACCC6,BCA39D,9D6B6F,7D303B,57373B,3F2A31" },
					{ name = "CORRUPTED", description = "Corrupted Metal", colors = "E2D9CC,D7CDC1,CDC2B1,C3B398,9D5875,800A12,C3B398,9D5875,800A12,61464B,3B2328" },
					...
					--blue armour
					{ name = "LOYALIST_BLUE", description = "Loyalist Blue", colors = "FFFFFF,E3F4F4,C6E7E7,ACDBDB,94C6C6,7BA7AF,638C94,4A6F80,31526B,243E4E,182931"},
					{ name = "LOYALIST_CAVALIER", description = "Cavalier", colors = "FFFFFF,ECECEC,C6E7E7,B3C8C7,A0B9B8,879E9F,6E8387,566971,3F505C,2B3C46,182931"},
					{ name = "LOYALIST_GRAND_KNIGHT", description = "Grand Knight", colors = "FFFFFF,E3EBEB,C6E7E7,C5CFDA,AAADBA,8F8895,676C78,3F505C,2B3C46,20333D,182931"},
					{ name = "LOYALIST_PALADIN", description = "Paladin", colors = "FFFFFF,F6F6F6,ECECEC,D8E0E7,C5CFDA,95BAB7,66A5B2,4B7B8E,31526B,385163,3F505C"},
					{ name = "KARRAG", description = "Karrag THoT", colors = "DBE6E8,C4D9DC,ADCCD2,8AB2BA,6799A2,51828B,3B6C75,2E545C,213D43,1C333A,182931"},
					{ name = "WITNESS", description = "Witness THoT", colors = "FFFFFF,D8F5F6,B1EBEC,95C2CC,79A9B3,648993,4F6973,4F6C66,507059,374848,1E3038"},

					--dark armour
					{ name = "SIR_GERRIK", description = "Sir Gerrik SG", colors = "C3D2EF,B1C0DE,9FAECB,8493B0,697895,53637F,3D4E69,33445F,293A55,1D2D49,11203D"},
					{ name = "HEAVY_INFANTERY", description = "Heavy Infantry", colors = "ECECEC,C9C6C2,A8A098,908279,78655A,62544D,4D4541,3C3532,2C2623,221F1E,191919"},
					{ name = "ROYAL_WARRIOR", description = "Royal Warrior", colors = "DCCACA,C2B7BA,A9A5AB,979298,858086,6F6B70,5A565A,464046,332D32,2F292D,2C2623"},
					{ name = "CHEVALIER", description = "Chevalier (Rashy Era)", colors = "ECECCF,DCD7C4,CCC2B9,BAB1A8,A8A098,888078,686058,524D47,3D3A37,292827,151718"},
					{ name = "SEACAPTAIN_STEEL", description = "Sea Captain Steel SotA", colors = "FFFFFF,ECECEF,DCDBDF,C9C7CC,B6B4BA,98979F,7B7B85,676770,53535B,43434A,34343A"},
					{ name = "BANNERET", description = "Banneret EI", colors = "ECECEC,DCD7C4,CCC2B9,BAB1A8,A8A098,888078,686058,5D574F,524E46,47443E,3D3A37"},

					--gold/bronze armour
					{ name = "DRAKE", description = "Drake Armour", colors = "FFFFFF,E8F4CC,D1E997,CCB17C,C79962,B08343,996D24,A4541E,AF3C18,7D371E,4C3324"},
					{ name = "GOLD_NEW", description = "Gold 1.18", colors = "FFFFFF,FFF1C6,FFE38C,FFD767,FFCC43,E2A322,C67B02,A35D0D,804018,73301A,66211B"},
					{ name = "GOLD_OLD", description = "Gold 1.16", colors = "FFFFFF,F6F6F6,ECECEC,DECB87,D1B563,B48639,985810,744111,512A13,401D11,2F1010"},
					{ name = "EE_PALADIN", description = "Paladin EI", colors = "FFFFFF,F6F6F6,ECECEC,F7DC88,FFCC43,D7A32D,AF7A18,8B4D19,66211B,4A1815,2F1010"},
					{ name = "BRONZE", description = "Siege Trooper Bronze", colors = "FFFFFF,E6D8B3,CCB066,BB8B47,AA6A28,955520,804018,7A3A1A,74341C,432D25,13262E"},

					--javeliner leather/orcish/assassin/dunefolk
					{ name = "LOYALIST_JAVELINEER", description = "Javelineer", colors = "FFFFFF,EBEBCE,D6D69C,B4B184,938D6D,726F53,525239,454533,39382D,34241E,2F1010"},
					{ name = "DUNEFOLK", description = "Dunefolk", colors = "FFFFFF,FFFAB0,FFF5A0,EAC995,D6BD8A,AEA37D,888670,727454,5C6339,4C4B25,3D3411"},
					{ name = "ORC", description = "Orc", colors = "FFFFD5,FFEEAE,FFDD88,D4BB77,AA9966,948859,7F774C,686442,515138,3F3F32,2D2D2D"},
					{ name = "ASSASSIN", description = "Assassin", colors = "AAC0A0,9BAC90,889880,6C806C,506858,415245,333D33,2D3932,273631,212829,1C1B21"},

					--undead armour
					{ name = "SKELETON_RIDER", description = "Skeleton Rider", colors = "F8F8A0,E2D483,CCB066,BB8B47,AA6A28,8F4F22,74341C,523E3E,304860,213747,13262E"},
					{ name = "SKELETON", description = "Skeleton", colors = "FFFFFF,FFFFE7,FFFFCE,EADCB5,D6D69C,CFD396,C8D090,AEB281,949473,737356,525239"},
					{ name = "DEATHKNIGHT", description = "Death Knight", colors = "FFFFFF,EFEFF3,E0E0E8,C1C4C9,A3A7AB,8B8894,73697E,684F59,5E3535,382D31,13262E"},
					{ name = "GHOST", description = "Ghost", colors = "FFFFFF,EFEFF3,E0E0E8,C1C4C9,A3A7AB,8B8894,73697E,684F59,5E3535,43322E,283028"},
					{ name = "NECROMANCER", description = "Necromancer", colors = "FFFFFF,E9DFD4,D2BDA9,BAB2B2,A3A7AB,8B8894,73697E,827556,91822F,775B32,5E3535"},
					{ name = "NECROMANCER_CTL", description = "Necromancer (CtL)", colors = "C3C1C1,AFADAD,9B9B9B,8D8D8D,808080,646464,484848,4F4F4F,575757,393939,1B1B1B"},

					--GSE
					{ name = "GSE_MILITA", description = "Great Steppe Era Militia", colors = "FFFFFF,D5F2FB,ABE5F6,8ACCE7,69BBD9,4A87C1,2B52A9,1E3682,121B5C,130D49,140036"},
					{ name = "GSE_CANNONEER", description = "Great Steppe Era Cannoneer", colors = "FFFFFF,C8E9DD,92D2BB,76C1AC,5BB19E,449B83,2D8569,206E60,125756,0E4048,0A293B"},

					--wose/elf
					{ name = "WOSE", description = "Wose", colors = "FFFFCA,F2F2B8,E6E6A6,D7B184,C99462,A6784B,835C35,6D4B24,573A14,462E13,352313"},
					{ name = "KALIAN_ELF", description = "Kalian Elf TroW", colors = "E8EBE7,E0D6CB,D8C2AD,BDA787,A28D62,957B51,896941,7C5B30,704D1F,5B372D,47213C"},
					{ name = "ELF_DARKER", description = "Elvish Armour Dark", colors = "E8EDD5,C6D0B5,A4B496,86967C,687862,4C5A49,313B31,2B322A,252A23,1B1E1A,121311"},
					{ name = "ELF_LIGHTER", description = "Elvish Armour Light", colors = "FFFFFF,F3F6EA,E8EDD5,C6D0B5,A4B496,86967C,687862,4C5A49,313B31,2B322A,252A23"},

					--merfolk
					{ name = "MERFOLK", description = "Merfolk", colors = "FFFFFF,F8F8F4,F2F2EA,E5DAC8,D8C2AD,C5B892,B3AE78,7C7C5D,484B42,4C463C,504137"},
					{ name = "MERFOLK_MAGE", description = "Merfolk Siren", colors = "CDF8F8,E2FBFB,F8F8F8,E8DDD4,D8C2AD,BDA787,A28D62,72724D,425838,3D3D28,382218"},
					{ name = "MERFOLK_HOPLITE", description = "Merfolk Hoplite", colors = "CDF8F8,E0F5F1,F2F2EA,D2D0B1,B3AE78,AB9E6D,A28D62,756C52,484B42,4C463C,504137"},
					{ name = "AQUANA", description = "Aquana (Rashy Era)", colors = "FEFEFE,F1F0E0,E5E2C2,DDD7B7,D8CCAD,BCB687,A2A062,8B8754,746E47,56522F,383618"},
					{ name = "MERFOLK_JAVELINEER", description = "Merfolk Javelineer", colors = "F2F2EA,D7D8D3,BDBEBD,AAAFB3,979FA9,727C8B,4D586D,525C68,586164,4C5254,404444"},

					--UTBS
					{ name = "DAWARF", description = "Dawarf", colors = "F8C8E8,EAB0D7,DB98C6,D188BB,C878B0,AC6498,905080,744074,583068,44204C,301030"},
					{ name = "FLESHGOLEM", description = "Fleshgolem", colors = "DBD2A4,DCBC9B,DCA993,DD978C,DE8685,D47D6F,CA7559,B96853,A85C4E,954E48,824143"},
					{ name = "IXTHALA", description = "Ixthala", colors = "CECCEA,BEBCE1,AFACD9,9C96C6,8A81B3,7475A7,5E699C,525983,474A6B,343751,222438"},
					{ name = "DARK_ASSASSIN_MASK", description = "Dark Assassin Mask", colors = "ECC3C1,DCA9A6,CC8F8C,B47D7D,9D6B6F,8D4D55,7D303B,6A333B,57373B,453032,342A29"},
					{ name = "DARK_ASSASSIN_CLOAK", description = "Dark Assassin Cloak", colors = "C3A89F,B09995,9C8B8B,958282,8F7A7A,816B6B,74605D,685350,5C4744,4A3734,372725"},
					{ name = "UTBS_HUMAN", description = "UtbS Human", colors = "FFFFFF,E8E8CC,D1D199,B5B577,999955,77723D,554C26,403317,2C1A09,1A1005,090602"},

					--animal parts
					{ name = "JUMPING_SPIDER", description = "Jumping Spider", colors = "FFE6D6,EDDCEB,DCD1FF,CDBDFA,BBABED,9381D3,6B57B9,6452AC,5E4DA1,3E3074,1E1348"},
					{ name = "SCORPLING", description = "Scorpling", colors = "FFFFFF,EDDBCB,DAB6C4,CEABB4,C19FA5,B29294,A38583,917371,7F615F,643F43,491D27"},
					{ name = "TENTACLE", description = "Tentacle", colors = "FFFFFF,E6E6E6,CDCDCD,B0B3B3,94999A,7E8084,68676F,595E68,4A5661,3D383B,311A16"},
					{ name = "SEASERPENT", description = "Sea Serpent", colors = "D9FFFF,C3E7E7,ADCFCF,9AB8B8,87A1A1,719095,5B7F8A,4D6F7E,405F72,3C505C,384247"},
					{ name = "SCARAB", description = "Scarab", colors = "FFFFFF,D2EFD5,A5DEAB,8CD494,74C67E,70B474,6CA26A,68905F,657E55,576F48,49613B"},
					{ name = "SCORPIAN", description = "Scorpion", colors = "CDE5FE,C1D6EC,B6C8DA,9CA6BF,8384A3,717291,5F607F,50566E,414C5E,2F3C53,1D2C49"},
					{ name = "CRAB", description = "Crab", colors = "FFFFFF,EEE8E5,DDD3CD,C9BFB8,B6ACA4,A39378,917B4D,7D6A42,695937,473C23,261F10"},
					{ name = "BAT", description = "Vampire Bat", colors = "E5A490,C98C7C,AD7569,985F63,84495E,7E4B51,794D44,693C3F,592B3B,3A232A,1B1B1B"},
					{ name = "BLOODBAT", description = "Blood Bat", colors = "FB9254,F48848,EC7E3D,D36A2E,BA5520,A8461C,963718,711B0C,4D0000,410000,350000"},
					{ name = "DREADBAT", description = "Dread Bat", colors = "999999,848484,707070,5F5F5F,4E4E4E,414141,353535,2F2F2F,292929,212121,191919"},
					{ name = "DREADBAT_METAL", description = "Dread Bat Metal", colors = "CDCDCD,9E9E9E,707070,5F5F5F,4E4E4E,414141,353535,2F2F2F,292929,212121,191919"},
					{ name = "ANT", description = "Ant", colors = "B1D2D6,A0BDC3,90A8B0,9091B2,907AB5,8071A4,706993,606081,505870,522C49,550022"},
					{ name = "FIREANT", description = "Fire Ant", colors = "FFE9B3,FFD87B,FFC843,FF8522,FF4301,D73800,B02E00,992208,821611,6B0B19,550022"},

					--rashy era
					{ name = "DARDO", description = "Dardo (Rashy Era)", colors = "EACFC2,D3B3A3,BD9785,A4817B,8B6C71,725358,593A3F,463134,33282A,292325,1F1F1A"},
					{ name = "MARASHY", description = "Marashy (Rashy Era)", colors = "FDFFEA,DEEBB9,BDD6E6,AFB1A4,A28D62,6F7356,3D5A4B,414F48,454545,343434,232323"},
					{ name = "LUZ", description = "Paladin Luz (Rashy Era)", colors = "FFFFFF,EBE0B5,D6BE6B,C1AA59,AD9748,9A853B,88742F,736124,5E4E1A,463A12,2F270A"},

					-- Default grey troll
					{ name = "TROLL_GREY", description = "Troll Grey", colors = "D0CFBF,BCB2B3,A8A8A8,8E938D,747F73,6A7063,616153,4C5244,374336,273533,172830" },

					-- earthen/stone colors for the randomizer 
					{ name = "TROLL_LIGHTEARTHEN", description = "Light Earth", colors = "FAF3C9,F8E3B2,F6D39B,DCB482,C5956A,B7875C,A9794F,925D40,7B4231,5E3120,422110" },
					{ name = "TROLL_WOODENEARTH", description = "Wooden Earth", colors = "E6E6A6,D7BD84,C99462,A6784B,835C35,6D4B24,573A14,462E13,352313,241B13,131414" },
					{ name = "TROLL_EARTHEN", description = "Earth", colors = "D9AC79,CBA072,BC946B,B78663,B3785B,9B643D,844C1F,653B1F,462D1F,332217,201810" },
					{ name = "TROLL_GOBLINMUD", description = "Goblinmud", colors = "FFCE39,DFA720,C08008,AD6C0C,985810,8C4C14,804018,6C341C,582820,401C18,281010" },
					{ name = "TROLL_DARKERMUD", description = "Darker Mud", colors = "CBBC7F,AEA06F,918460,786D4E,60573C,4E462F,3C3623,2E2C1E,22221A,1D1D15,191911" },
					{ name = "TROLL_DARKMUD", description = "Dark Mud", colors = "FFD087,F0BB7B,E2A76F,BC8655,97663C,775A36,574D31,474234,383838,39362F,3B3427" },
					{ name = "TROLL_DARKGREEN", description = "Dark Green", colors = "889880,80887C,797979,647068,506858,415245,333D33,2A2F28,22221E,1D1D19,191915" },
					{ name = "TROLL_DARKBRIGHTSTONE", description = "Dark Bright Stone", colors = "D5D59B,C0B780,AA9966,9E966C,939372,727255,515138,3F3F32,2D2D2D,222A2E,172830" },
					{ name = "TROLL_SANDSTONE", description = "Sandstone", colors = "F8F8A0,FAF8B7,FFFFCE,EADCB5,D6D69C,B5B587,949473,737356,525239,3F3F2D,2D2E22" },
					{ name = "TROLL_TEAMCOLOR", description = "Teamcolor", colors = "F49AC1,F17AB1,EF5BA1,E22D90,D6007F,B9006E,9E005D,83004B,690039,5F0031,55002A" },
					{ name = "TROLL_MOLTEN", description = "Molten", colors = "F7DF8E,EDD67A,E2CD67,EA8A49,F3A62C,D17122,AF3C18,9E2B15,8E1A12,7E211E,6F282B" },
					{ name = "TROLL_OLDGREEN", description = "1.0 Troll", colors = "90F8B8,7FE3A3,6ECD8F,5FB67F,50A070,418C62,327855,256442,185030,143C20,102810" },
					{ name = "TROLL_GRUU", description = "Grüü (SotBE)", colors = "D3BCC1,BDB2B4,A8A8A8,94928C,817D71,726662,635054,544843,454133,2E3431,172830" }
				},
			},
		}
	},
		...
		data = {
			youth = {
				...
				variants = {
					...
					{ name = "RED_FIGHTER", description = "Red Fighter Metal", colors = "BD696E,9F2133,6A343B,3F2A31" },
					{ name = "RED_ASSASSIN", description = "Red Assassin Metal", colors = "EACCC6,BCA39D,CC8F8C,3F2A31" },
					{ name = "BLUE_YOUTH", description = "Blue Youth Metal", colors = "78C1B2,4C91C9,4A707A,4A2E62" },
			...
			fighter = {
				...
				variants = {
					...
					{ name = "RED_YOUTH", description = "Red Youth Metal", colors = "DACBCB,C4ABAB,B38E8E,8A4C4C,664B50,50363B,3B2328" },
					{ name = "RED_ASSASSIN", description = "Red Assassin Metal", colors = "F3E1DD,EACCC,BCA39D,9D6B6F,7D303B,57373B,3F2A31" },
			...
			assassin = {
				unit_types = { "Dark Assassin Uncloaked" },
				base = "EACCC,BCA39D,9D6B6F,7D303B,57373B,3F2A31",
				variants = {
		...
		data = {
			corrupted = {
				...
				variants = {
					...
					{ name = "RED_YOUTH", description = "Red Youth Metal", colors = "B38E8E,8A4C4C,664B50,50363B,3B2328" },
					{ name = "RED_FIGHTER", description = "Red Fighter Metal", colors = "D9AEA6,BD696E,9F2133,6A343B,3F2A31" },
					{ name = "RED_ASSASSIN", description = "Red Assassin Metal", colors = "BCA39D,9D6B6F,7D303B,57373B,3F2A31" },
					{ name = "BLUE_YOUTH", description = "Blue Youth Metal", colors = "A4F19D,78C1B2,4C91C9,4A707A,4A2E62" },
					{ name = "BLUE_FIGHTER", description = "Blue Fighter Metal", colors = "FFE593,8B9A88,585E74,4A2E62" },
					--blue armour
