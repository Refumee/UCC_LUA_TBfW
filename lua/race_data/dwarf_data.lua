...
local body_parts = {
	{
		...
		data = {
			dwarf = ucc_structure(
				...
				"FFFFFF,B1EBEC,93CFC5,58808D,31526B,21353E",
				armour_variants
			),
			miner = ucc_structure(
                {	"Dwarvish Miner"},
				"CADAD7,9E948D,747171,4A5668,3A3A50,2C1D2B",
				armour_variants
			),
			guard = ucc_structure(
                {	"Dwarvish Guardsman"},
				"DAB0A4,A8A098,8A766D,4E3A2D,352419,271A11",
				armour_variants
			),
			sentinel = ucc_structure(
                {	"Dwarvish Stalwart", "Dwarvish Sentinel"},
				"B1EBEC,8ABCB8,58808D,26446D,21353E,1C2123",
				armour_variants
			),
		}
	},
	{
		...
		description = "Beard",
		data = {
			berserker = ucc_structure(
				{	"Dwarvish Ulfserker", "Dwarvish Berserker"}, 
				"B2EBEC,94CFC5,59808D,2E4A4F", 
				beard_variants
			),
			fighter = ucc_structure(
				{	"Dwarvish Fighter", "Dwarvish Steelclad", "Dwarvish Lord"}, 
				"F9EDC5,E1C3A2,898868,4E3A2D", 
				beard_variants
			),
			guard = ucc_structure(
				{	"Dwarvish Guardsman", "Dwarvish Stalwart", "Dwarvish Sentinel"}, 
				"EFE498,EFC66D,D1804D,843F1E", 
				beard_variants
			),
			scout = ucc_structure(
				{	"Dwarvish Scout", "Dwarvish Pathfinder", "Dwarvish Explorer"}, 
				"DBB0A4,B0937F,903D14,592820", 
				beard_variants
			),
			runesmith = ucc_structure(
				{	"Dwarvish Runesmith", "Dwarvish Runemaster", "Dwarvish Arcanister"}, 
				"FEFFFF,E1C3A2,B0937F,4F3A2D", 
				beard_variants
			),
			miner = ucc_structure(
				{	"Dwarvish Miner"}, 
				"E08B7A,B14B4B,8B3219,592010", 
				beard_variants
			),
			witness = ucc_structure(
				{	"Dwarvish Witness", "Dwarvish Annalist", "Dwarvish Loremaster"}, 
				"EFC66D,D1804D,8B4422,44260D", 
				beard_variants
			),
			karrag = ucc_structure(
				{	"Dwarvish Rune Lord", "Undead Dwarvish Rune Lord"}, 
				"C7CFDC,9F9C99,757A7B,4E5053", 
				beard_variants
			),
		}
	},
