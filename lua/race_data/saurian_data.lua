		...
		data = {
			wose = {
				...
				variants = {
					...
					{ name = "SCALE_SHIFT_LIGHTDRAKEARMOUR", description = "Drake light armour Saurian", colors = "FFFFFF,FFFFFF,D1E997,D1E997,C79962,C79962,C79962,4C3324" },
					{ name = "SCALE_SHIFT_DARKPURPLE", description = "Dark purple Saurian", colors = "4631A5,4631A5,8D61AB,8D61AB,6C4372,6C4372,6C4372,33162D" },
