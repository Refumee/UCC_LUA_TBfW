...
local body_parts = {
	{
		...
		data = {
			wolf = {
				...
				variants = {
					{ name = "WOLF_FUR", description = "Wolf Fur", colors = "f0e9ae,f3c274,a59077,796433,494a46,4d1d08"},
					{ name = "WOLF_PILLAGE_FUR", description = "Pillager Wolf Fur", colors = "ffd3a7,d09b4c,a35b67,494a46,18222d,4d1d08"},
					{ name = "GREAT_WOLF_FUR", description = "Great Wolf Fur", colors = "ffd3a7,cd9d6f,826c79,4a503e,2c2319,4d1d08"},
					{ name = "DIREWOLF_FUR", description = "Direwolf Fur", colors = "d0cbdd,859a94,826c79,4a503e,2c2319,4d1d08"},
					{ name = "GREAT_RED_WOLF_FUR", description = "Great Red Wolf Fur", colors = "ffd3a7,d09b4c,a35b67,5b4556,18222d,4d1d08"},
					--transition colors 3 wolf-rider 3 direwolf
					{ name = "WOLF_FUR_WOLF_PILLAGE_FUR", description = "Wolf/Pillager Wolf merge", colors = "f8deab,e2af60,a4766f,61573d,31363a,4d1d08"},
					{ name = "WOLF_FUR_GREAT_RED_WOLF_FUR", description = "Wolf/Red Great Wolf merge", colors = "f8deab,e2af60,a4766f,6a5545,31363a,4d1d08"},
					{ name = "WOLF_FUR_GREAT_WOLF_FUR", description = "Wolf/Great Wolf merge", colors = "f8deab,e0b072,947e78,625a39,3b3730,4d1d08"},

					{ name = "WOLF_PILLAGE_FUR_DIREWOLF_FUR", description = "Direwolf/Pillager Wolf merge", colors = "e8cfc2,ab9b70,936470,4a4d42,222323,4d1d08"},
					{ name = "GREAT_RED_WOLF_FUR_DIREWOLF_FUR", description = "Direwolf/Red Great Wolf merge", colors = "e8cfc2,ab9b70,936470,534b4a,222323,4d1d08"},
					{ name = "GREAT_WOLF_FUR_DIREWOLF_FUR", description = "Direwolf/Great Wolf merge", colors = "e8cfc2,a99c82,826c79,4a503e,2c2319,4d1d08"},
					--rare colors
					{ name = "WHITE_WOLF_FUR", description = "White", colors = "ffffff,eeeeee,bababa,8b8b8b,6f6f6f,4f4f4f"},
					{ name = "WHITEGREY_WOLF_FUR", description = "Grey", colors = "dBDBDB,C8C8C8,949494,656565,494949,292929"},
					{ name = "BLACK_WOLF_FUR", description = "Black", colors = "9b9b9b,888888,545454,252525,090909,000000"},
					--new colors
					{ name = "WOL_GOBLIN_CAV_FUR", description = "WoL Goblin Cavalry", colors = "d98e5f,a86f4b,713e2d,4d1d08,2c2319,4d1d08"},
					{ name = "WOL_CUTTHROAT_FUR", description = "WoL Cutthroat", colors = "ba9a7a,ab803f,85303e,382b35,232336,4d1d08"},
					{ name = "WOL_GOBLIN_LANCER_FUR", description = "WoL Goblin Lancer", colors = "a86f4b,713e2d,4d1d08,2c2319,0e0421,4d1d08"},
					{ name = "WOL_GOBLIN_HELLWOLF_FUR", description = "WoL Goblin Hellwolf Rider", colors = "8b6156,634f45,40332d,1e1815,2c2319,4d1d08"},
					{ name = "HEAVY_INFANTERY_WOLF_FUR_COLOR", description = "Heavy Infantry Fur Color", colors = "dccaca,a8a098,78655a,4d4541,2c2623,191919"},
					{ name = "WOLF_DUNEFOLK_ARMOUR_FUR_COLOR", description = "Dunefolk Fur color", colors = "f5e5c2,cfb99f,a79e7e,7f7165,625454,453843"},
					{ name = "WOLF_WALKING_CORPSE_FUR", description = "Walking Corpse Fur", colors = "d6d69c,999063,767146,555e3e,634258,452938"},
					{ name = "WOLF_WALKING_CORPSE_RIDER_FUR", description = "Walking Corpse Rider Fur", colors = "d8d0a6,999063,77633b,5a5a48,6f4f48,452938"},
					{ name = "WOLF_SOULLESS_FUR", description = "Soulless Fur", colors = "e1c7dc,9ca093,826c79,612a17,555e3e,2d2215"},
					{ name = "WOLF_SOULLESS_RIDER_FUR", description = "Soulless Corpse Rider Fur", colors = "d0cbdd,859a94,826c79,4d1d08,4a503e,2c2319"},
					{ name = "WOLF_FROSTSTOAT_FUR", description = "Frost Stoat Fur", colors = "ecebe0,d0cebc,b3b098,7c7751,474b36,2d3529"}
				},
			},
			pillager_wolf = {
	...
	},
	{
		...
		data = {
			goblinrider = { -- archtype
				...
				variants = {
					{ name = "Orcish Armour", description = "Default orcish armour", colors = "FFFFFF,FFFFD5,FFFFCE,D5D59B,FFDD88,AA9966,79746D,84754A,939372,66663E,555533,515138,2B2C16,333333,2D2D2D" },
