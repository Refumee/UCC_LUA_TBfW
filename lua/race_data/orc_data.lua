	...
	},
	{
		...
		data = {
			shaman = {
				...
				variants = {
					{ name = "ORCISH_SHAMAN_CLOTH_COLOR", description = "Orc Shaman", colors = "9AAB60,80813D,554C1B,524919,312B0A"},

					{ name = "ORCISH_SHAMAN_CLOTH_DARKER", description = "Darker Cloth", colors = "818442,5c572c,41493a,41493a,212e1a"},
					{ name = "ORCISH_SHAMAN_CLOTH_GREENPURPLE", description = "Green Purple", colors = "93a167,6e6962,433455,433455,000001"},
					{ name = "ORCISH_SHAMAN_CLOTH_GREENRED", description = "Green Red", colors = "a19f7c,77744f,603b3a,603b3a,213b25"},
					{ name = "ORCISH_SHAMAN_CLOTH_BROWNREDPURPLE", description = "Brown Red Purple", colors = "826e2f,75491e,47213c,47213c,3F1519"},
					{ name = "ORCISH_SHAMAN_CLOTH_BROWNGREY", description = "Brown Grey", colors = "84754a,594e2f,47433f,47433f,2b2c16"},
					{ name = "ORCISH_SHAMAN_CLOTH_DARKBROWN", description = "Dark Brown", colors = "a08662,796755,423934,423934,221c1a"},
					{ name = "ORCISH_SHAMAN_CLOTH_LIGHTBROWN", description = "Light Brown", colors = "cda184,93614a,653618,653618,38160a"},
					{ name = "ORCISH_SHAMAN_CLOTH_BROWNGREYGREEN", description = "Brown Greygreen", colors = "8f6c61,6b4936,475044,475044,472b27"},
					{ name = "ORCISH_SHAMAN_CLOTH_ORANGEBLUE", description = "Orange Blue", colors = "d08159,8d697a,203c56,203c56,0d2b45"},
					{ name = "ORCISH_SHAMAN_CLOTH_BLUE", description = "Blue", colors = "50596e,273541,273a48,273a48,1d2336"},
					{ name = "ORCISH_SHAMAN_CLOTH_PURPLE", description = "Purple", colors = "9d7d95,684e67,50445a,50445a,322a3f"},
					{ name = "ORCISH_SHAMAN_CLOTH_GREY", description = "Grey", colors = "909090,6f6f6f,434343,434343,212121"},
					{ name = "ORCISH_SHAMAN_CLOTH_GREYBROWN", description = "Grey Brown", colors = "576d6d,8a7d5d,593f33,593f33,221e23"},
					{ name = "ORCISH_SHAMAN_CLOTH_GREYRED", description = "Grey Red", colors = "aaaa8e,717171,553939,553939,393939"},

					--faction clothing
					{ name = "ORCISH_SHAMAN_CLOTH_DUNEBURNER", description = "Dune Burner", colors = "D5D3A1,A09F84,7F7165,7F7165,453843"},
					{ name = "ORCISH_SHAMAN_CLOTH_DUNEHERBALIST", description = "Dune Herbalist", colors = "B8A641,798D63,535E2D,535E2D,303313"},
					{ name = "ORCISH_SHAMAN_CLOTH_DARKDUNE", description = "Dark Dune Cloth", colors = "e6e6cc,aaaa8e,717171,717171,393939"},
					{ name = "ORCISH_SHAMAN_CLOTH_LIGHTDUNE", description = "Light Dune Cloth", colors = "f6f6da,d5d3a1,bab98b,bab98b,4b4142"},
					{ name = "ORCISH_SHAMAN_CLOTH_HUMANMAGE", description = "Mage Cloth", colors = "b18134,8a5c2f,75462F,4e3430,2D2410"},
					{ name = "ORCISH_SHAMAN_CLOTH_REDMAGE", description = "Red Mage Cloth", colors = "C5956A,A9794F,876246,876246,4E3430"},
					{ name = "ORCISH_SHAMAN_CLOTH_ARCHMAGE", description = "Arch Mage Cloth", colors = "cabca2,a4977e,847860,635841,4b402b"},
					{ name = "ORCISH_SHAMAN_CLOTH_SILVER_MAGE", description = "Silver Mage Cloth", colors = "C0D7E0,90B3C0,7EA0A0,69788A,384062"},
					{ name = "ORCISH_SHAMAN_CLOTH_WHITE_MAGE", description = "White Mage Cloth", colors = "C0D7E0,90B3C0,69788A,69788A,425361"},
					{ name = "ORCISH_SHAMAN_CLOTH_MAGE_HOOD", description = "Mage Hood Cloth", colors = "BFBFBF,808080,8A949F,595959,4D4D4D"},
					{ name = "ORCISH_SHAMAN_CLOTH_SILVER_MAGE_HOOD", description = "Silver Mage Hood Cloth", colors = "D6D6D6,ABABAB,7A7A7A,7A7A7A,4D4D4D"},
					{ name = "ORCISH_SHAMAN_CLOTH_WHITE_MAGE_HOOD", description = "White Mage Hood Cloth", colors = "D3CBBB,8A949F,305068,626C76,3C454F"},
					{ name = "ORCISH_SHAMAN_CLOTH_ROGUE_MAGE", description = "Rogue Mage Cloth", colors = "636363,474747,3D3D00,2B281D,152114"},
					{ name = "ORCISH_SHAMAN_CLOTH_DARKADEPT", description = "Dark Adept Cloth", colors = "a5b89c,889880,506858,506858,283028"},
					{ name = "ORCISH_SHAMAN_CLOTH_ELVISHSHAMAN", description = "Elvish Shaman Cloth", colors = "efff9c,9cde5a,529439,529439,4f7229"},
					{ name = "ORCISH_SHAMAN_CLOTH_SAURIANAUGUR", description = "Saurian Augur Cloth", colors = "ffffff,9b9c92,515249,515249,17212c"},
					{ name = "ORCISH_SHAMAN_CLOTH_SAURIANORACLE", description = "Saurian Oracle Cloth", colors = "ffffff,8dc2c2,2c4c6c,2c4c6c,17212c"},
					{ name = "ORCISH_SHAMAN_CLOTH_SAURIANPROPHET", description = "Saurian Prophet Cloth", colors = "ffd44a,ffe59d,bf6d00,bf6d00,581802"},
					{ name = "ORCISH_SHAMAN_CLOTH_SAURIANSEER", description = "Saurian Seer Cloth", colors = "ffffff,ffd44a,bf6d00,bf6d00,581802"}
				},
			},
		}
	},
		...
		data = {
			orc = {
                unit_types = { 
                    ...
                    "Afterlife Orcish Archer","Afterlife Orcish Crossbowman", "Afterlife Orcish Slurbow",
                    "Afterlife Orcish Leader", "Afterlife Orcish Ruler", "Afterlife Orcish Sovereign",
					"Orcish Assassin", "Orcish Slayer", "Orcish Nightblade", "Afterlife Orcish Assassin",
					"Afterlife Orcish Slayer", "Afterlife Orcish Nightblade", "Orcish Shaman", "Orcish Adept",
					"Orcish Sorceress", "Afterlife Orcish Elder Witch2", "Afterlife Orcish Elder Witch2", "Afterlife Orcish Shamaness2"
                },
				base = "ffce39,F8C842,c08008,985810,804018,582820",
				variants = {
